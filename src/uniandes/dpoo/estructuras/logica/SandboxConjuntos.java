...
public class SandboxConjuntos
{
    ...
    {	
    	if (arbolCadenas.size() == 0 || this.arbolCadenas.last().compareTo(cadena) < 0) {
    		return new TreeSet<String>( );
    	};
    		
        return this.arbolCadenas.subSet(cadena,true, this.arbolCadenas.last(),true);
    }
     ...
     */
    public void reiniciarConjuntoCadenas( List<String> objetos )
    {
    	arbolCadenas = new TreeSet<String>();
    	for (int i=0; i<objetos.size(); i++)
    	{
    		arbolCadenas.add(objetos.get(i));
    	}
    }
    ...
    {	
    	List<String> cadena = getCadenasComoLista();
    	if (arbolCadenas.size() != 0)
    	{
    		for(int i=0; i<cadena.size(); i++)
    		{
        		arbolCadenas.remove(cadena.get(i));
        		arbolCadenas.add(cadena.get(i).toUpperCase());
        	}
    	}
    }
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
    	...
    	{
    		if (arbolCadenas.contains(i) == false)
    		{
    			return false;
    		}
    	}
